...
<h4 class="text-domocreativo mb-3">Ver Tipo de Servicio</h4>
...
<div class="row">
    <div class="col-md-5">
        <div class="card shadow-sm">
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <p class="form-control-plaintext"><?= $tipo["id_tipo_servicio"] ?></p>
                </div>
                <div class="mb-3">
        ...
        <div class="mt-3">
            ...
            <a href="index.php?accion=tipos_servicio" class="btn btn-secondary">Volver</a>
        </div>
    </div>
</div>
