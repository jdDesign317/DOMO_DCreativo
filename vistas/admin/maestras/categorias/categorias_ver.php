...
<h4 class="text-domocreativo mb-3">Ver Categoría</h4>
...
<div class="row">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <p class="form-control-plaintext"><?= htmlspecialchars($categoria["nombre"]) ?></p>
        </div>
        ...
        <div class="mt-3">
            <a href="index.php?accion=categorias_editar&id=<?= $categoria["id_categoria"] ?>"
