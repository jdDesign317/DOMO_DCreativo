...
if ($_SESSION["id_perfil"] != 2) {
    header("Location: /DOMOCreativo/index.php");
    exit;
}
...
<a href="index.php" class="btn btn-secondary mb-3">
    ...
    <!-- BOTON CREAR -->
    <a href="index.php?accion=usuarios_crear" class="btn btn-domocreativo mb-3">
    Nuevo Usuario
</a>
    <!-- TABLA -->
        ...
        <?php foreach ($usuarios as $usuario) : ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <!-- ELIMINAR -->
                    <a href="index.php?accion=usuarios_eliminar&id=<?= $usuario["id_usuario"] ?>" 
