    ...
    <?php if ($items && $items->num_rows > 0): ?>
        ...
        <?php while ($i = $items->fetch_assoc()): ?>
            ...
            <tr>
                ...
                <td>
                    <a href="/DOMOCreativo/index.php?accion=carrito_quitar&id=<?= $i["id_detalle"] ?>"
...
<div class="mb-3">
    ...
    <a href="/DOMOCreativo/index.php?accion=productos" class="btn btn-warning">
        Seguir comprando
    </a>

    <a href="/DOMOCreativo/index.php?accion=carrito_vaciar" class="btn btn-danger">
        Vaciar carrito
    </a>
